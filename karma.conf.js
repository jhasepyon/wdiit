...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      {pattern: 'app/bower_components/angularLocalStorage/src/angularLocalStorage.js', included: false },
      {pattern: 'app/bower_components/jquery-xml2json/src/xml2json.js', included: false },
